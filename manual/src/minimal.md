...
After sucessfully installing MerKurio (follow the [documentation](https://lschoenm.github.io/MerKurio/installation.html)) and having it added to your PATH, run the following commands to test MerKurio:
...
In this minimal example, no output files are generated. The records and matching statistics are directly written to the terminal. For a description of the [plain text log](./log.md) and [JSON log](./json.md), go to the official documentation.
